...
**Theme:** light
**Source:** https://aesop.com
**Refero Style:** https://styles.refero.design/style/24c0de95-295d-42aa-8240-4e36683cf35b
...
### Product Card â Animal

### Product Carousel Section â New and Notable
...
:root {
  ...
  --color-umber: #945c26;
  --font-suisseintl: 'SuisseIntl', Inter, Helvetica Neue, ui-sans-serif, system-ui, sans-serif;
  --font-zapf-humanist: 'Zapf-Humanist', Optima, Palatino, ui-sans-serif, system-ui, sans-serif;
  --text-caption: 11px;
  --leading-caption: 1.7;
  --text-body: 14px;
  --leading-body: 1.6;
