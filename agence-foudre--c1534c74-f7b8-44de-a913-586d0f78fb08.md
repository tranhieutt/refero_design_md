...
> Vibrant Pink Playground â heavy type dances on a clean white stage, punctuated by electric color accents.
...
| Deep Forest | `#00522d` | `--color-deep-forest` | Primary text, interactive elements, button background in specific contexts â provides grounding contrast to the vibrant pink. |
| Foudre Pink | `#db3c8a` | `--color-foudre-pink` | Key branding color for headlines, badges, and prominent interactive elements â injects energy and distinctiveness. It's the primary accent. |
...
| Midnight Ink | `#000000` | `--color-midnight-ink` | Used for utility text, icons, and some card elements â provides maximum contrast against lighter backgrounds. |
...
### Service Cards â Foudre Pink & Deep Forest
...
3. **Design a 'Foudre Pink' content card:** Background #db3c8a (Foudre Pink), 25px border radius, 60px padding (all sides). Inside, a heading 'Analyse de lâexistant' using 'Clash Grotesk' font, weight 700, size 30px, line-height 0.85, color #fff8f6 (Pale Canvas). Below it, body text using 'Clash Grotesk' font, weight 400, size 16px, line-height 0.85, color #fff8f6 (Pale Canvas).
...
:root {
  ...
  --font-clash-grotesk: 'Clash Grotesk', Inter, ui-sans-serif, system-ui, sans-serif;
  --font-beni: 'Beni', Bebas Neue, ui-sans-serif, system-ui, sans-serif;
  --text-caption: 10px;
