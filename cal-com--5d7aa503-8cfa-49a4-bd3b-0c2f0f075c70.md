...
:root {
  ...
  --font-cal-sans: 'Cal Sans', Poppins, Gilroy, ui-sans-serif, system-ui, sans-serif;
  --font-cal-sans-ui-variable-light: 'Cal Sans UI Variable Light', Inter Light, ui-sans-serif, system-ui, sans-serif;
  --font-inter: 'Inter', system-ui, -apple-system, sans-serif, ui-sans-serif, system-ui, sans-serif;
