...
**Refero Style:** https://styles.refero.design/style/df5e2be4-c2bd-42bb-bbc7-409bae6355c3
...
| --- | --- | --- | --- |
| Coinbase Blue | `#0052ff` | `--color-coinbase-blue` | Primary CTAs, logos, active states â the core brand identifier. |
...
:root {
  ...
  --font-coinbasedisplay: 'CoinbaseDisplay', Manrope, ui-sans-serif, system-ui, sans-serif;
  --font-coinbasesans: 'CoinbaseSans', Inter, ui-sans-serif, system-ui, sans-serif;
  --font-coinbasetext: 'CoinbaseText', Inter, ui-sans-serif, system-ui, sans-serif;
  --text-caption: 13px;
