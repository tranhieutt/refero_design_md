...
**Refero Style:** https://styles.refero.design/style/9f228e72-997a-4410-9190-68359028e3d0
...
| Mint | `#9bd8a9` | `--color-mint` | Decorative background shapes, UI tags â a primary brand pastel. |
| Marigold | `#fde99b` | `--color-marigold` | Decorative background shapes, UI highlights â a warm primary brand pastel. |
| Periwinkle | `#b8caf5` | `--color-periwinkle` | Decorative background shapes, UI highlights â a cool primary brand pastel. |
...
| heading | 46px | 1.1 | - | `--text-heading` |
| heading-lg | 56px | 1.05 | - | `--text-heading-lg` |
| display | 66px | 1.1 | - | `--text-display` |
...
:root {
  ...
  --color-papaya: #ff4500;
  --color-azure: #0087ff;
  --font-untitledseriffont: 'UntitledSerifFont', Lora, Merriweather, ui-sans-serif, system-ui, sans-serif;
  --font-untitledsansfont: 'UntitledSansFont', Inter, Figtree, ui-sans-serif, system-ui, sans-serif;
  --text-caption: 12px;
  --leading-caption: 1.5;
  --text-body-sm: 14px;
  --leading-body-sm: 1.5;
