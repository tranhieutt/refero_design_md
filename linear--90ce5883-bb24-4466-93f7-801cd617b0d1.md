...
| Neon Lime | `#e4f222` | `--color-neon-lime` | Primary action indicators, active states, and focus elements â a high-energy focal point. |
...
:root {
  ...
  --font-berkeley-mono: 'Berkeley Mono', IBM Plex Mono, ui-sans-serif, system-ui, sans-serif;
  --text-caption: 10px;
  --leading-caption: 1.4;
  --text-body: 14px;
  --leading-body: 1.4;
