...
**Theme:** light
**Source:** https://miti-navi.com
**Refero Style:** https://styles.refero.design/style/887f0c74-c696-4589-82ae-85705ecda919
...
Create a Hero Headline: 'Les voiliers de nos r̻ves' using Voyage, 400 weight, 72px size, normal letter-spacing, color Deep Charcoal (#000e13).
...
:root {
  ...
  --font-voyage: 'Voyage', Playfair Display, ui-sans-serif, system-ui, sans-serif;
  --font-gtsectradisplay: 'GTSectraDisplay', Tiempos Text, ui-sans-serif, system-ui, sans-serif;
  --font-times: 'Times', Times New Roman, ui-sans-serif, system-ui, sans-serif;
  --font-gt-pressura-mono: 'GT Pressura Mono', Space Mono, ui-sans-serif, system-ui, sans-serif;
  --text-caption: 10px;
  --leading-caption: 1.4;
  --text-body-sm: 12px;
  --leading-body-sm: 1.4;
