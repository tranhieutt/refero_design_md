...
:root {
  ...
  --font-geistmono: 'GeistMono', Fira Code, Source Code Pro, ui-sans-serif, system-ui, sans-serif;
  --text-caption: 12px;
  --leading-caption: 1.5;
  --text-body-sm: 14px;
  --leading-body-sm: 1.5;
