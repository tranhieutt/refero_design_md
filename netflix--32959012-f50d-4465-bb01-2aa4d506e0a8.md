...
**Refero Style:** https://styles.refero.design/style/32959012-f50d-4465-bb01-2aa4d506e0a8
...
| --- | --- | --- | --- |
| Netflix Red | `#e50914` | `--color-netflix-red` | Brand logo, primary CTAs, active indicators â the single, powerful accent that drives action and defines identity. |
...
### More Reasons to Join â Feature Cards
...
:root {
  ...
  --font-netflix-sans: 'Netflix Sans', Roboto, Inter, ui-sans-serif, system-ui, sans-serif;
  --text-caption: 13px;
  --leading-caption: 1.5;
  --text-body: 16px;
  --leading-body: 1.5;
