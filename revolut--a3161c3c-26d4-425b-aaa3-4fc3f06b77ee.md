...
| display | 53px | 1.17 | - | `--text-display` |
| display-xl | 89px | 1 | - | `--text-display-xl` |
...
### Button Group â Primary Dark, Primary Light, Ghost

### Social Proof â Stats & Awards Block

### Savings Feature Card â Interest Rate CTA
...
:root {
  ...
  --font-aeonik-pro: 'Aeonik Pro', Sohne, Neue Haas Grotesk, ui-sans-serif, system-ui, sans-serif;
  --font-inter: 'Inter', Inter, San Francisco, Roboto, ui-sans-serif, system-ui, sans-serif;
  --text-caption: 12px;
  --leading-caption: 1.5;
  --text-body-sm: 14px;
