...
**Refero Style:** https://styles.refero.design/style/6323a42b-3b47-4774-92e4-15651a9ba2ac
...
| --- | --- | --- | --- |
| Ignition Orange | `#ffa41c` | `--color-ignition-orange` | Primary CTAs and eyebrow labels â the sole warm accent, providing a clear, unmissable call to action. |
...
:root {
  ...
  --font-tomorrow: 'Tomorrow', Share Tech Mono, Roboto Mono, ui-sans-serif, system-ui, sans-serif;
  --font-inter: 'Inter', Inter, Roboto, sans-serif, ui-sans-serif, system-ui, sans-serif;
