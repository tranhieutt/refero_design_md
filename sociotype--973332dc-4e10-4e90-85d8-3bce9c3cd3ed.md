...
**Theme:** light
**Source:** https://socio-type.com
**Refero Style:** https://styles.refero.design/style/973332dc-4e10-4e90-85d8-3bce9c3cd3ed
...
### Main Onsite - Main Onsite â detected in extracted data but not described by AI - `--font-main-onsite`
- **Weights:** 400
...
- **Role:** Main Onsite â detected in extracted data but not described by AI
...
| --- | --- | --- | --- | --- |
| caption | 11px | 1.38 | - | `--text-caption` |
| body | 14px | 1.29 | - | `--text-body` |
| heading | 26px | 1.13 | - | `--text-heading` |
| display-sm | 40px | 1 | - | `--text-display-sm` |
| display | 251px | 1.25 | - | `--text-display` |
...
:root {
  ...
  --font-onsite: 'Onsite', system-ui, sans-serif, ui-sans-serif, system-ui, sans-serif;
  --font-avec-sharp: 'Avec Sharp', serif, ui-sans-serif, system-ui, sans-serif;
  --font-ceno: 'Ceno', serif, ui-sans-serif, system-ui, sans-serif;
  --font-meso: 'Meso', serif, ui-sans-serif, system-ui, sans-serif;
  --font-gestura: 'Gestura', serif, ui-sans-serif, system-ui, sans-serif;
  --font-rework: 'Rework', serif, ui-sans-serif, system-ui, sans-serif;
  --text-caption: 11px;
