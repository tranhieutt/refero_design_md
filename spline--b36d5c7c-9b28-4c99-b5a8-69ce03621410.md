...
| Spline Blue | `#0062ff` | `--color-spline-blue` | Primary CTA buttons â the single, high-energy action color |
...
:root {
  ...
  --font-spline-sans: 'Spline Sans', Inter, ui-sans-serif, system-ui, sans-serif;
  --font-spline-sans-mono: 'Spline Sans Mono', IBM Plex Mono, ui-sans-serif, system-ui, sans-serif;
  --text-caption: 13px;
  --leading-caption: 1.5;
  --text-body: 16px;
  --leading-body: 1.5;
