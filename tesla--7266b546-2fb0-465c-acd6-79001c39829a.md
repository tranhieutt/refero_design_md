...
### Offer Cards â Current Offers & American Heroes

### Bottom Action Bar â Ask a Question & Schedule a Drive
...
:root {
  ...
  --color-onyx: #171a20;
  --color-carbon: #000000;
  --font-universal-sans-display: 'Universal Sans Display', Inter, Manrope, ui-sans-serif, system-ui, sans-serif;
  --font-universal-sans-text: 'Universal Sans Text', Inter, SF Pro Text, ui-sans-serif, system-ui, sans-serif;
  --font-roboto: 'Roboto', Roboto, system-ui, ui-sans-serif, system-ui, sans-serif;
  --text-caption: 11px;
  --leading-caption: 1.2;
  --text-body: 14px;
  --leading-body: 1.43;
