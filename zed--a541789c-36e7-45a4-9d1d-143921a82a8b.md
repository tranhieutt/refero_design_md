...
**Refero Style:** https://styles.refero.design/style/a541789c-36e7-45a4-9d1d-143921a82a8b
...
### Stat Block â Open Source Metrics
...
:root {
  ...
  --font-writer: 'Writer', Inter, ui-sans-serif, system-ui, sans-serif;
  --font-zed-mono: 'Zed Mono', IBM Plex Mono, ui-sans-serif, system-ui, sans-serif;
  --font-plex-serif: 'Plex Serif', IBM Plex Serif, ui-sans-serif, system-ui, sans-serif;
  --font-ui-monospace: 'ui-monospace', Menlo, ui-sans-serif, system-ui, sans-serif;
  --text-caption: 10px;
  --leading-caption: 1.1;
  --text-heading: 26px;
